...
public class AuthController(IAuthUserHandler handler) : ControllerBase
{
    ...
    public async Task<IResult> RegisterAsync([FromBody] UserModelCredentialsDto registerRequest,
    ...
    public async Task<IResult> LoginAsync([FromBody] UserModelCredentialsDto loginRequest,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<IResult> LoginGoogleAsync([FromBody] GoogleLoginCommand loginCommand,
        CancellationToken cancellationToken)
    {
