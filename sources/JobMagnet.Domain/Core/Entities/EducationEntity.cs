...
{
    [SetsRequiredMembers]
    public EducationEntity(string degree, string institutionName, string institutionLocation, DateTime startDate, DateTime? endDate, string description, long summaryId = 0, long id = 0)
    {
