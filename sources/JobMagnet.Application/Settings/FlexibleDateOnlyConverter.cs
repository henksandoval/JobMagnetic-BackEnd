...
public class FlexibleDateOnlyConverter : JsonConverter<DateOnly?>
{
        ...
        bool hasExistingValue, JsonSerializer serializer)
    {
        ...
        if (reader.TokenType == JsonToken.String)
        {
            ...
            if (DateOnly.TryParseExact(dateString, Format_YYYY_MM_DD, CultureInfo.InvariantCulture, DateTimeStyles.None,
            ...
            if (dateString.Length == Format_YYYY_MM.Length &&
                DateOnly.TryParseExact(dateString + "-01", Format_YYYY_MM_DD, CultureInfo.InvariantCulture,
            ...
            if (dateString.Length == Format_YYYY.Length &&
                DateOnly.TryParseExact(dateString + "-01-01", Format_YYYY_MM_DD, CultureInfo.InvariantCulture,
                    DateTimeStyles.None, out result))
                return result;
            ...
            throw new JsonSerializationException(
                $"Could not parse date string '{dateString}' to DateOnly. Expected formats: YYYY-MM-DD, YYYY-MM, or YYYY.");
        }
